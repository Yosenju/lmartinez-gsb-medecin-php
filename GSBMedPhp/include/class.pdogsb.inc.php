 ...
 * 
 * @return un tableau associatif de clé pour les visiteurs
*/
...
*/
     ...
     * @param $idFrais
     */
    public function refusFraisHorsForfait($idFrais) {
        $req ="UPDATE lignefraishorsforfait SET libelle = CONCAT('REFUSE : ', libelle) where id=$idFrais AND libelle NOT LIKE 'REFUSE%'";
        PdoGsb::$monPdo->exec($req);
    }
/**
...
*/	
	public function getLesInfosFicheFrais($idVisiteur,$mois){
        ...
        public function getListeVA(){
		$req = "select idVisiteur,nom,prenom,mois
